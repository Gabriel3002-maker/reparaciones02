...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ec.gob.loja.reparaciones.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ec.gob.loja.reparaciones.security.DomainUserDetailsService", "createSpringSecurityUser");
